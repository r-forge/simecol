...
the Holling II functional response to scenario 1 and the Lotka-Volterra
...
clotka <- new("odeModel",
  ...
  times  = c(from=0, to=100, by=0.5),
  init   = c(prey=0.5, predator=1),
  ## a special solver function that evaluates funclist
...
compromise between execution speed and programming effort. Programming
