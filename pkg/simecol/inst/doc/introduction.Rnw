...
\begin{align}
\frac{dX_1}{d1} &= k_1 X_1 - k_2 X_1 X_2   \label{e:lv1}\\
\frac{dX_2}{d1} &= - k_3 X_1 + k_2 X_1 X_2 \label{e:lv2}
\end{align}
...
\begin{alignat}{2}
\frac{dX_1}{d1} &= 0.2 \cdot 0.5 - 0.2 \cdot 0.5 \cdot 1 &= 0 \\
\frac{dX_2}{d1} &= -0.1 \cdot 1  + 0.2 \cdot 0.5 \cdot 1 &= 0
\end{alignat}
...
We wish to express our thanks to René Sachse for suggestions while developing 
