/* How to write a dynamic model in C or C++
...
/*
  A typical C trick to get readable names for the parameters
...
/* Functions that are called from R must have an interface in "C" and not C++ */
extern "C" {
